...
public:
	...
	/**
	 * \brief Visualizes 16-bit bar pattern on the visualization device. (IoWarrior Extension Board)
	 *
	 * \param data [in] data to visualize
	 */
	virtual void writeBarPattern(uint16_t data)=0;

	/**
	 * \brief Visualizes 8-bit bar pattern on visualization device.  (IoWarrior Base Board)
	 *
	 * \param data [in] data to visualize
	 */
	virtual void writeBarPattern(uint8_t data)=0;
